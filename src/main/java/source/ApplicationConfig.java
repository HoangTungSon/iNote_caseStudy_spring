...
import source.formatter.NoteTypeFormatter;
import source.model.NoteType;
import source.service.NoteService;
import source.service.NoteTypeService;
import source.service.impl.NoteServiceImpl;
import source.service.impl.NoteTypeServiceImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"source.model"});
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/source");
        dataSource.setUsername("root");
        dataSource.setPassword("Tungson97..");
        return dataSource;
    }
